...
export default function CopperPricing() {
  return (
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 text-base md:text-lg font-medium max-w-xl mb-8">
                Copper is priced against the LME copper cash price, adjusted for grade, volume, and delivery terms.
              </p>
              ...
              <div className="space-y-5">
                {[
                  { title: "Grade", desc: "Adjusted for grade." },
                  { title: "Volume", desc: "Adjusted for volume." },
                  { title: "Delivery Terms", desc: "Adjusted for delivery terms." }
                ].map((item, i) => (
