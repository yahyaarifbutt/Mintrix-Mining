...
export default function RubyPricing() {
  return (
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 text-base md:text-lg font-medium max-w-xl mb-8">
                Ruby pricing is determined by the four Cs — color, clarity, cut (where applicable), and carat — referenced against GIA-comparable grading and current auction market comparables. Inquiries are handled on a per-lot basis given the unique nature of gemstone valuation.
              </p>
              ...
              <div className="space-y-5">
                {[
                  { title: "Color", desc: "The primary driver of ruby valuation." },
                  { title: "Clarity", desc: "Assessment of inclusions and transparency." },
                  { title: "Cut (where applicable)", desc: "Maximizing color and yield from the rough." },
                  { title: "Carat", desc: "Premium pricing applied to larger weight stones." }
                ].map((item, i) => (
