        ...
        <div className="flex flex-col justify-center space-y-10 py-4">
          <ClientAnimations delay={0.2}>
            <h2 className={`${montserrat.className} text-3xl md:text-5xl font-extrabold text-white mb-6 tracking-tight`}>
              Grade & <span className="text-[#D1A741]">Documentation</span>
            </h2>
            <p className="text-base sm:text-lg text-gray-400 font-medium leading-relaxed">
              Each lot is meticulously processed and accompanied by a complete suite of legal and technical documentation:
            </p>
          </ClientAnimations>

          <ul className="space-y-6 sm:space-y-8">
            {[
              { title: "Assay Certificate", desc: "Confirming gold content and precise purity." },
              { title: "Origin Documentation", desc: "From the physical mine site directly to export." },
              { title: "Export Compliance", desc: "Full customs clearance and export documentation." },
              { title: "Chain-of-Custody", desc: "Transparent records for traceable, conflict-free provenance." }
            ].map((item, idx) => (
