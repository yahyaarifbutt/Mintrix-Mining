...
export default function LithiumHero() {
  return (
    <>
      ...
      {/* FIX: Using min-h to allow vertical expansion on varying desktop/laptop aspect ratios */}
      <section className="relative w-full min-h-[100dvh] lg:min-h-[85vh] flex flex-col lg:flex-row bg-[#050505] overflow-hidden">
        ...
        {/* FIX: Removed fixed percentages, added dynamic padding (py-16) for reliable vertical centering */}
        <div className="w-full lg:w-[55%] flex-1 lg:flex-none flex flex-col justify-center py-16 lg:py-20 px-6 sm:px-12 lg:pl-[8%] lg:pr-12 xl:pl-[10%] xl:pr-16 relative z-10">
          ...
          <ClientAnimations delay={0.2}>
            {/* FIX: Adjusted max text size to 4rem and added break-words for graceful wrapping */}
            <h1 className={`${montserrat.className} text-4xl sm:text-5xl lg:text-[3.5rem] xl:text-[4rem] leading-[1.1] font-extrabold text-white tracking-tight uppercase mb-4 sm:mb-5 break-words`}>
              ...
              <span className="text-[#D1A741] text-3xl sm:text-4xl lg:text-[2.75rem] xl:text-5xl mt-1 block">
                For the Battery and<br/>Energy Storage Market
              </span>
            </h1>
          </ClientAnimations>
          ...
          <ClientAnimations delay={0.3}>
            <div className="border-l-2 border-[#D1A741] pl-4 sm:pl-5 mb-6 sm:mb-8">
              <p className="text-white/95 text-[13px] sm:text-base font-medium leading-relaxed max-w-xl drop-shadow-md">
                Lithium demand from EV manufacturers and energy storage producers consistently exceeds available supply. Mintrix offers battery-grade and technical-grade lithium to buyers who need a traceable, scalable African source for their procurement pipeline.
              </p>
            </div>
          </ClientAnimations>

          <ClientAnimations delay={0.4}>
            {/* FIX: Swapped w-max for flex-wrap so buttons stack neatly if squeezed */}
            <div className="flex flex-col sm:flex-row flex-wrap items-center gap-3 sm:gap-4 w-full">
              ...
              >
                ...
                Request Lithium Pricing <ArrowRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 group-hover:translate-x-1 transition-transform" />
              </Link>
        ...
        {/* FIX: Applied min-height rules here to prevent image collapsing on mobile/weird ratios */}
        <div className="w-full lg:w-[45%] min-h-[40vh] lg:min-h-full relative group overflow-hidden bg-[#050505]">
          <div 
            ...
            style={{ backgroundImage: "url('/Images/lithiumImage1.webp')" }} 
          />
          ...
          {/* FIX: Improved gradient transition for standard mobile stack views */}
          ...
          <div className="absolute bottom-6 right-6 lg:bottom-10 lg:right-10 flex flex-col gap-2 sm:gap-3 z-30 scale-[0.85] sm:scale-100 origin-bottom-right">
            ...
            <ClientAnimations delay={0.5}>
              <div className="flex items-center gap-3 px-4 py-2.5 rounded-2xl bg-[#050505]/80 backdrop-blur-md border border-white/10 shadow-2xl hover:border-[#D1A741]/50 transition-colors duration-300">
                {/* FIX: Added shrink-0 to prevent icon squishing */}
                ...
                <div>
                  <p className={`${montserrat.className} text-white text-[10px] font-bold uppercase tracking-wider`}>Africa Base</p>
                  <p className="text-[#D1A741]/70 text-[8px] uppercase tracking-widest font-medium">Scalable Volume</p>
                </div>
              </div>
            </ClientAnimations>
            ...
            <ClientAnimations delay={0.6}>
              <div className="flex items-center gap-3 px-4 py-2.5 rounded-2xl bg-[#050505]/80 backdrop-blur-md border border-white/10 shadow-2xl hover:border-[#D1A741]/50 transition-colors duration-300">
                ...
                <div>
                  <p className={`${montserrat.className} text-white text-[10px] font-bold uppercase tracking-wider`}>Battery-Grade</p>
                  <p className="text-[#D1A741]/70 text-[8px] uppercase tracking-widest font-medium">Traceable Source</p>
                </div>
              </div>
            </ClientAnimations>
