    ...
    <section className="bg-black py-24 px-6 relative overflow-hidden border-y border-[#D1A741]/20">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16 md:mb-20">
          <h3 className="text-[#D1A741] font-bold tracking-[0.2em] uppercase text-sm mb-4">
            Key Metrics
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 relative">
          {stats.map((stat, index) => (
            <div key={index} className="relative">
              ...
              {/* Vertical Divider (Desktop Only) - Not on the last item */}
              ...
              {/* Horizontal Divider (Mobile Only) - Not on the last item */}
              {index !== stats.length - 1 && (
